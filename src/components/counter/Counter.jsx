...
function Counter() {
  const { count, inputValue, animate, setInputValue, counterUp, counterDown, handleReset, handleSetValue } = useCounter();
    ...
    <div className="container">
      <div className="main">
        ...
        <div className="controls">
          ...
          <button className="btn decrement" onClick={() => counterDown()}> <img src={downicon} alt=""/></button>
        </div>
